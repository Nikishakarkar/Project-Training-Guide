...
<body>
<center>
<form action="viewupdateproject.php" method="post">
<table width="341" border="1">
<tr>
    <td colspan="2" align="center" background="images/title.jpg">Edit Project Detail </td>
</tr>
  <tr>
    <td width="171">Project Branch </td>
    <td width="154"><label>
